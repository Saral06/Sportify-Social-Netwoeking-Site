    ...
    class Post
    {
        ...
        public function create_post($userid,$data,$files)
        {
            if(!empty($data['post'])||!empty($files['file']['name'])||isset($data['is_profile_image'])||isset($data['is_cover_image']))
            {
                ...
                else
                {
                    if(!empty($files['file']['name']))
                    {
                        ...
                        if(!file_exists($folder))
                        {
                            ...
                            file_put_contents($folder."index.php",""); //security purpose
                        }
                ...
                $query="insert into posts (postid,userid,post,image,has_image,is_cover_image,is_profile_image) values ('$postid','$userid','$post','$myimage','$has_image','$is_cover_image','$is_profile_image')";
            ...
            {
                $this->error.="Post can't be empty!<br>";
            }
        ...
        public function i_own_post($postid,$sportify_userid)
        {
            if(!is_numeric($postid))
            {
                return false;
            ...
            if(is_array($result))
            {
                if($result[0]['userid']==$sportify_userid)
                {
                    return true;
                }
            }
        ...
        public function like_post($id,$type,$sportify_userid)
        {
                ...
                if(is_array($result))
                {
                    ...
                    if(!in_array($sportify_userid,$user_ids)) //entry exist therefore unlike
                    {
                        $arr["userid"]=$sportify_userid;
                    ...
                    {
                        $key=array_search($sportify_userid,$user_ids);
                        unset($likes[$key]);
